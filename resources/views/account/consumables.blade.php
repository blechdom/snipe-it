    ...
    <div class="box box-default">
        <div class="box-body">
          ...
          data-cookie-id-table="consumablesTable-{{ config('version.hash_version') }}-{{ config('version.hash_version') }}">
            <thead>
              <tr>
                <th data-sortable="true" data-searchable="true" data-field="name_account">{{ trans('admin/consumables/table.title') }}</th>
                <th data-searchable="true" data-sortable="true" data-field="category_account">Consumable {{ trans('general.category') }}</th>
